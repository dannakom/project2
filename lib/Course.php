...
class Course implements ISavable
{
    ...
    public function connectToDB($str)
    {
    ...
    public function delete($id)
    {
        ...
        $result = connectToDB("DELETE FROM courses WHERE id = $id");
    ...
    public function read()
    {
        ...
        $result = $conn->query("SELECT * FROM courses");
        //$result=connectToDB("SELECT * FROM courses");
    ...
    public function get($id)
    {
        ...
        $result = connectToDB("SELECT name, description, image FROM courses WHERE id=$id");
